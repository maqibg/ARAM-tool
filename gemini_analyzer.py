...
如果这不是英雄联盟「海克斯大乱斗」或「大乱斗」的加载界面（必须能看到左右各5张英雄卡片），请直接回复纯JSON：
...
If this is NOT a League of Legends loading screen (must show 5 champion cards on each side), reply with pure JSON ONLY:
{"error": "not_loading_screen"}
